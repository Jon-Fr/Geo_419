...
os.chdir("C:/Users/Jonathan/Desktop/nützlich/Uni/Module/Semester_7/Geo_419/task")
...
test_array = data_array[600, 600:800]
print(numpy.amax(test_array), numpy.amin(test_array))
matplotlib.pyplot.hist(test_array, bins="auto")
matplotlib.pyplot.show()

# change scaling to log
data_array_log = 10*numpy.log10(data_array, out=numpy.zeros_like(data_array), where=(data_array != 0))
print(numpy.amax(data_array_log), numpy.amin(data_array_log))
